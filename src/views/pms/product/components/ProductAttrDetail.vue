<template>
    <div style="margin-top: 50px">
        <el-form :model="value" ref="productAttrForm" label-width="120px" class="form-inner-container">
            ...
            <el-form-item label="商品规格：">
                ...
                <el-table style="width: 100%; margin-top: 20px" :data="value.skuStockList" border>
                    ...
                    <el-table-column label="操作" width="80">
                        <template v-slot="scope">
                            <el-button link type="danger" @click="handleRemoveProductSku(scope.$index, scope.row)"
                                >删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <el-button type="primary" style="margin-top: 20px" @click="handleRefreshProductSkuList"
                    >刷新列表
                </el-button>
                <el-button type="primary" style="margin-top: 20px" @click="handleSyncProductSkuPrice"
                    >同步价格
                </el-button>
                <el-button type="primary" style="margin-top: 20px" @click="handleSyncProductSkuStock"
                    >同步库存
                </el-button>
            </el-form-item>
            ...
            <el-form-item label="商品详情：">
                <el-tabs v-model="activeHtmlName" type="card">
                    <el-tab-pane label="电脑端详情" name="pc">
                        <RichEditor :width="595" :height="300" v-model:value="value.detailHtml"></RichEditor>
                    </el-tab-pane>
                    <el-tab-pane label="移动端详情" name="mobile">
                        <RichEditor :width="595" :height="300" v-model:value="value.detailMobileHtml"></RichEditor>
                    </el-tab-pane>
                </el-tabs>
            </el-form-item>
...
export default {
    ...
    components: { SingleUpload, MultiUpload, RichEditor },
    props: {
        value: Object,
        isEdit: {
            type: Boolean,
    ...
    emits: ['prevStep', 'nextStep', 'update:value']
};
</script>

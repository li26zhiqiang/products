<template>
    <div style="margin-top: 50px">
        <el-form :model="value" ref="productSaleForm" label-width="120px" class="form-inner-container">
            ...
            <el-form-item v-show="value.promotionType === 3">
                <el-table :data="value.productLadderList" style="width: 80%" border>
                    ...
                    <el-table-column label="操作">
                        <template v-slot="scope">
                            <el-button link type="danger" @click="handleRemoveProductLadder(scope.$index, scope.row)"
                                >删除</el-button
                            >
                            <el-button link type="primary" @click="handleAddProductLadder(scope.$index, scope.row)"
                                >添加</el-button
                            >
                        </template>
                    </el-table-column>
            ...
            <el-form-item v-show="value.promotionType === 4">
                <el-table :data="value.productFullReductionList" style="width: 80%" border>
                    ...
                    <el-table-column label="立减" width="120">
                        <template v-slot="scope">
                    ...
                    <el-table-column label="操作">
                        <template v-slot="scope">
                            <el-button link type="danger" @click="handleRemoveFullReduction(scope.$index, scope.row)"
                                >删除</el-button
                            >
                            <el-button link type="primary" @click="handleAddFullReduction(scope.$index, scope.row)"
                                >添加</el-button
                            >
                        </template>
                    </el-table-column>

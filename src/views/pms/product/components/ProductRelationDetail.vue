<template>
    <div style="margin-top: 50px">
        <el-form :model="value" ref="productRelationForm" label-width="120px" class="form-inner-container">
...
export default {
    ...
    methods: {
        ...
        handleFinishCommit() {
            $emit(this, 'finishCommit', this.isEdit);
        }
    },
    emits: ['finishCommit', 'prevStep', 'update:value']
};
</script>

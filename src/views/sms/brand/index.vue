<template>
    <div class="app-container">
        ...
        <el-card class="operate-container" shadow="never">
            <el-button type="primary" class="btn-add" @click="handleSelectBrand()">选择品牌</el-button>
        ...
        <div class="table-container">
            ...
            >
                ...
                <el-table-column label="品牌名称">
                    <template v-slot="scope">{{ scope.row.brandName }}</template>
                </el-table-column>
        ...
        <el-dialog title="选择品牌" v-model="selectDialogVisible" width="660px">
            <el-input
        ...
        <el-dialog title="设置排序" v-model="sortDialogVisible" width="660px">
            <el-form :model="sortDialogData" label-width="90px">

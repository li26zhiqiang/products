        ...
        <el-card shadow="never">
            ...
            <el-card shadow="never" style="margin-top: 15px">
                <div class="operate-container">
                    <el-icon class="color-danger" style="margin-left: 20px"><ElIconWarning /></el-icon>
                    <span class="color-danger">当前订单状态：{{ formatStatus_filter(order.status) }}</span>
                    ...
                    <div class="operate-button-container" v-show="order.status === 4">
                        <el-button type="danger" @click="handleDeleteOrder">删除订单</el-button>
                        <el-button @click="showMarkOrderDialog">备注订单</el-button>
                    </div>
                </div>
            ...
            <el-dialog title="修改收货人信息" v-model="receiverDialogVisible" width="660px">
                <el-form :model="receiverInfo" ref="receiverInfoForm" label-width="90px">
                    <el-form-item label="收货人姓名：">
                        <el-input v-model="receiverInfo.receiverName" class="input-width"></el-input>
                    </el-form-item>
                    <el-form-item label="手机号码：">
                        <el-input v-model="receiverInfo.receiverPhone" class="input-width"> </el-input>
                    </el-form-item>
                    <el-form-item label="邮政编码：">
                        <el-input v-model="receiverInfo.receiverPostCode" class="input-width"> </el-input>
                    </el-form-item>
                ...
                <template v-slot:footer>
                    <span class="dialog-footer">
                        ...
                        <el-button type="primary" @click="handleUpdateReceiverInfo">确定</el-button>
                    </span>
                </template>
            </el-dialog>

            <el-dialog title="修改费用信息" v-model="moneyDialogVisible" width="660px">
                <div class="table-layout">
                    <el-row>
                        <el-col :span="6" class="table-cell-title">商品合计</el-col>
                        <el-col :span="6" class="table-cell-title">运费</el-col>
            ...
            <el-dialog title="发送站内信" v-model="messageDialogVisible" width="660px">
                <el-form :model="message" ref="receiverInfoForm" label-width="60px">
                    <el-form-item label="标题：">
                        <el-input v-model="message.title" class="input-width"></el-input>
                    </el-form-item>
                    <el-form-item label="内容：">
                        <el-input v-model="message.content" type="textarea" rows="3" class="input-width"> </el-input>
                    </el-form-item>
                </el-form>
                <template v-slot:footer>
                    <span class="dialog-footer">
                        <el-button @click="messageDialogVisible = false">取消</el-button>
                        <el-button type="primary" @click="handleSendMessage">确定</el-button>
                    </span>
                </template>
            </el-dialog>

            <el-dialog title="关闭订单" v-model="closeDialogVisible" width="660px">
                <el-form :model="closeInfo" label-width="90px">
                    <el-form-item label="操作备注：">
                        <el-input v-model="closeInfo.note" type="textarea" rows="3" class="input-width"> </el-input>
                    </el-form-item>
                </el-form>
                <template v-slot:footer>
                    <span class="dialog-footer">
                        <el-button @click="closeDialogVisible = false">取消</el-button>
                        <el-button type="primary" @click="handleCloseOrder">确定</el-button>
                    </span>
                </template>
            </el-dialog>

            <el-dialog title="备注订单" v-model="markOrderDialogVisible" width="660px">
                ...
                <template v-slot:footer>
                    <span class="dialog-footer">
                        <el-button @click="markOrderDialogVisible = false">取消</el-button>

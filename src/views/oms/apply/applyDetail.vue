<template>
    <div class="app-container">
        <el-page-header @back="onBack">
            ...
            <template #content>
                <span class="text-large font-600 mr-3">退货原因详情</span>
            </template>
        </el-page-header>
            ...
            <el-card shadow="never">
                ...
                <el-table border class="standard-margin" ref="productTable" :data="productList">
                    ...
                    <el-table-column label="小计" width="100">
                        <template v-slot="scope">￥{{ totalAmount }}</template>
                    </el-table-column>
                </el-table>
            ...
            <el-card shadow="never" class="standard-margin">
                ...
                <div class="form-container-border">
                    ...
                    <el-row>
                        ...
                        <el-col class="form-border font-small" :span="18">{{
                            formatStatus_filter(orderReturnApply.status)
                        }}</el-col>
                    </el-row>
                    <el-row>
                        <el-col
                        ...
                        <el-col class="form-border font-small" :span="18" style="height: 50px">
                            ...
                            <el-button link type="primary" @click="handleViewOrder">查看</el-button>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col class="form-border form-left-bg font-small" :span="6">申请时间</el-col>
                        <el-col class="form-border font-small" :span="18">{{
                            formatTime_filter(orderReturnApply.createTime)
                        }}</el-col>
                    </el-row>
                    <el-row>
                ...
                <div class="form-container-border">
                    ...
                    <div v-show="orderReturnApply.status !== 3">
                        ...
                        <el-row>
                            ...
                            <el-col class="form-border font-small" :span="18">{{
                                formatRegion_filter(currentAddress)
                            }}</el-col>
                        </el-row>
                        <el-row>
                ...
                <div class="form-container-border" v-show="orderReturnApply.status !== 0">
                    ...
                    <el-row>
                        ...
                        <el-col class="form-border font-small" :span="18">{{
                            formatTime_filter(orderReturnApply.handleTime)
                        }}</el-col>
                    </el-row>
                    <el-row>
                ...
                <div class="form-container-border" v-show="orderReturnApply.status === 2">
                    ...
                    <el-row>
                        ...
                        <el-col class="form-border font-small" :span="18">{{
                            formatTime_filter(orderReturnApply.receiveTime)
                        }}</el-col>
                    </el-row>
                    <el-row>
                ...
                <div style="margin-top: 15px; text-align: center" v-show="orderReturnApply.status === 0">
                    <el-button type="primary" @click="handleUpdateStatus(1)">确认退货</el-button>
                    <el-button type="danger" @click="handleUpdateStatus(3)">拒绝退货</el-button>
                </div>
                <div style="margin-top: 15px; text-align: center" v-show="orderReturnApply.status === 1">
                    <el-button type="primary" @click="handleUpdateStatus(2)">确认收货</el-button>
                </div>
            </el-card>
        </div>
    </div>
